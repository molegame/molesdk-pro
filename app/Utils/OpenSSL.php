...
class OpenSSL
{
    ...
    {
        openssl_sign($data, $signature, self::pkcs8PrivateKey($privateKey), OPENSSL_ALGO_SHA1);
        return $signature;
    }
    ...
    {
        return openssl_verify($data, $signature, self::pkcs8PublicKey($publicKey), OPENSSL_ALGO_SHA1);
    }
}
